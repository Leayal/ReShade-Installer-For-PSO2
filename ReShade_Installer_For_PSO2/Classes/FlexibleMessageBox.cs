...
namespace ReShade_Installer_For_PSO2.Classes
{
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        /// </summary>
        public static double MAX_WIDTH_FACTOR = 0.6;
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            internal const int BCM_SETSHIELD = 0x160C; //Elevated button
            ...
            private static void SetDialogButtons(FlexibleMessageBoxForm flexibleMessageBoxForm, MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
            {
                ...
                switch (buttons)
                {
                    ...
                    case MessageBoxButtons.YesNo:
                        ...
                        flexibleMessageBoxForm.button2.AutoSize = true;
                        flexibleMessageBoxForm.button2.Text = "Yes, please try to install as Admin";
                        // SendMessage(flexibleMessageBoxForm.button2.Handle, BCM_SETSHIELD, 0, 1);
                        Bitmap icon = new Bitmap(flexibleMessageBoxForm.button2.Height - 6, flexibleMessageBoxForm.button2.Height - 6);
                        ...
                        flexibleMessageBoxForm.button2.ImageAlign = ContentAlignment.MiddleLeft;
                        flexibleMessageBoxForm.button2.TextImageRelation = TextImageRelation.ImageBeforeText;
                        flexibleMessageBoxForm.button2.Image = icon;
